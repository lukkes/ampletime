import {_markdownTableToDict, _dictToMarkdownTable} from "./markdown.js";
import {_insertRowToDict} from "./data-structures.js";
import {_getCurrentTime, _calculateDuration} from "./date-time.js";
 ...
 */
export async function _getTaskDurations(app, dash, taskName, startDate, endDate) {
 ...
 */
export function _getEntriesWithinDates(tableDict, taskName, startDate, endDate) {
 ...
 */
export function _calculateTaskDurations(entries) {
