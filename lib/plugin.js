import {_focus} from "./amplefocus.js";
import {_generateReport, _loadScript, _promptTarget, _start, _stop} from "./ampletime.js";
...
const plugin = {
  ...
  appOption: {
    "Start...": async function(app) {
      ...
      try { await _start(app, this.options, target); } catch (err) { console.log(err); await app.alert(err); }
    },
